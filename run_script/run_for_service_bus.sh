...
# sh ./04.01.run_add_env_parameter.sh $RG_NAME $RG_LOCATION petshopboyz-module-final-order-service-southeastasia QUEUE_NAME=message "SERVICE_BUS_CONNECTION_STRING=Endpoint=sb://module-final-petshopboyz.servicebus.windows.net/;SharedAccessKeyName=order-titem-queue-shared-policy;SharedAccessKey=+962fgk+7bNO0lOTortumOm4V3tjJM3Rg+ASbExfPX0="
