...
sh ./04.01.run_add_env_parameter.sh $RG_NAME $REGION petshopboyz-$MODULE_NAME-order-service-southeastasia AZURE_COSMOS_ENDPOINT=https://modulefinalcosmosdb.documents.azure.com:443/ AZURE_COSMOS_KEY=Ge4qURriwGmP9ytzETdB68p8CZbiwB4FUIZACGSUclkcvmRcvrzdkKg2sYI6Zg4cjK5q77BIWHL4ACDbYePcSg== AZURE_COSMOS_DATABASE=OrderDatabase AZURE_COSMOS_CONTAINER=OrderContainer
